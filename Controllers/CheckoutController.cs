...
namespace Shop.Controllers
{
    ...
    public class CheckoutController : Controller
    {
        ...
        public async Task<IActionResult> CreateItems(CreateOrderViewModel model)
        {
            ViewData["AllCategories"] = _categoryRepository.GetAll().ToList();
            ViewData["Index"] = 0;
        ...
        public async Task<IActionResult> PlacingOrder(ShoppingCart shoppingCart)
        {
            ...
            return RedirectToAction(nameof(CheckoutController.CreateItems), "Checkout");
        }
        ...
        public async Task<IActionResult> Thanks(int Id, ShoppingCart shoppingCart)
        {
            shoppingCart.MakeEmpty();
            ViewData["AllCategories"] = _categoryRepository.GetAll().ToList();
