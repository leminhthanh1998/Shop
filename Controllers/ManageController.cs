...
namespace Shop.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        //            _categoryRepository.GetByName(model.Category), _sellerRepository.GetBySellerId(seller.SellerId), Offer.No, false);
            ...
            if (Order != null)
            {
                ...
                if (_user == _user2)
                {
                    if (_user.Bills.Count != 0 && _user.Bills != null)
                    {
                        foreach (Order b in _user.Bills)
                        {
                            foreach (OrderItem bon in Order.Orders)
                            {
                                bon.Validity = Validity.Invalid;
                            }
        ...
        public async Task<IActionResult> DetailOrder(int id)
        {
            ...
            if (Order != null)
            {
                ...
                if (_user == _user2)
                {
                    ...
                    var detailModel = new List<DetailOrderModel>();
                    ...
                    {
                        detailModel.Add(new DetailOrderModel
                        {
                            Name=name,
                    ...
                    ViewData["OrderItem"] = detailModel;
